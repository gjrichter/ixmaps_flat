		...
		try {
			if (1 || (szViewer != "Netscape")) {
				...
				// if not defined, try this                                    
					...
					map.Loader.importSVGFile("../../maps/svg/resources/svg/maplocal.svg", SVGDocument, SVGTempGroup, null);
...
function setSVGDocument(evt, embedName) {
	if (embedName) {
		...
		if (evt) {
            ...
            SVGDocument = document.getElementById("svg_map_document");
        }
	...
	var szNs = SVGDocument.getAttribute("xmlns:xmap");
...
Map.Scale = function () {
	...
	if (this.metadataNode) {
        ...
        console.log(szMapNs);
        console.log(this.metadataNode.getElementsByTagNameNS);
        console.log(this.metadataNode.getElementsByTagName("xmap:extension"));
