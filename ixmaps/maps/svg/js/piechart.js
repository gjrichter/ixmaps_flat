...
DonutChart.prototype.realize = function(){
	...
	if ( this.szStyle.match(/STARBURST/) && this.szStyle.match(/POLAR/) ) {
		...
		c = map.Dom.newShape('circle', this.targetGroup, this.mX,this.mY,radius, "fill:none;stroke:#444444;stroke-width:1px;"); 			c.setAttributeNS(szMapNs,"tooltip","range "+String((this.nMaxValue||100)*0.25) +"-"+ String((this.nMaxValue||100)*0.50));
