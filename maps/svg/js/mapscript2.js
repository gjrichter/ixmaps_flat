...
/* globals 
	ixMap, map, document, HTMLDocument, HTMLWindow, navigator, contextMenu, XMLHttpRequest, SVGDocument, szMapNs, szXlink, 
...
(function () {
    ...
    /**
     * Create a new ixMap.Viewport instance.  
     ...
     * @return A new ixMap.Viewport Object
     */
    ixMap.Viewport = function (evt) {
        ...
        if (map.Scale.metadataNode) {
            ...
            this.szPopupAlignment = map.szLocalPopupAlignment ? map.szLocalPopupAlignment : this.szPopupAlignment;
        }

        // GR 26.09.2007 set background color of map
        this.eventRect = map.SVGDocument.getElementById("mapbackground:eventrect");
        if (this.eventRect) {
            if (map.szMapBackgroundStyle) {
                this.eventRect.setAttributeNS(null, "style", map.szMapBackgroundStyle + ";pointer-events:all");
            }
            if (map.szMapBackgroundColor) {
                this.eventRect.setAttributeNS(null, "style", "fill:" + map.szMapBackgroundColor + ";opacity:1;pointer-events:all");
            }
        }
    ...
    ixMap.Viewport.prototype = new Map();

    /**
     * refresh map viewport (after resize)
     */
    ixMap.Viewport.prototype.reformat = function () {
        this.clipToolsGroup();
        this.createPanBorder();
        this.createNorthArrow();
    };
     ...
     */
    ixMap.Viewport.prototype.clipToolsGroup = function () {
        map.Dom.setClipRect(map.SVGToolsGroup, new box(map.Scale.mapPosition.x + map.Scale.normalX(map.nMapBorderWidth), map.Scale.mapPosition.y + map.Scale.normalY(map.nMapBorderWidth), map.Scale.bBox.width - map.Scale.normalX(map.nMapBorderWidth) * 2, map.Scale.bBox.height - map.Scale.normalY(map.nMapBorderWidth) * 2));

        this.widgetBox = new box(map.Scale.mapPosition.x + map.Scale.normalX(map.nMapBorderWidth), map.Scale.mapPosition.y + map.Scale.normalY(map.nMapBorderWidth + map.nToolMarginTop), map.Scale.bBox.width - map.Scale.normalX(map.nMapBorderWidth) * 2, map.Scale.bBox.height - map.Scale.normalY(map.nMapBorderWidth) * 2);
    };
    /**
     * create the panning buttons of the viewport map frame 
     */
    ixMap.Viewport.prototype.createPanBorder = function () {
        var SVGDoc = map.SVGDocument;
        if (map.fMapBorder) {
            var widgetGroup = SVGDoc.getElementById("widgets:antizoomandpan");
            if (widgetGroup) {
                var szFill = map.szMapBorderColor;
                var nWidth = map.Scale.normalX(map.nMapBorderWidth);
                ...
                if (map.fMapBorder3D && map.Scale.mapPosition.x) {
                    szFill = "#ffffff";
                    widgetGroup.insertBefore(newGroup, widgetGroup.firstChild);
                    ...
                    if (map.nMapBorderWidth > 2) {
                        var szStyle = map.szMapPanBorderStyle + ";stroke-width:" + map.Scale.normalX(1) + ";opacity:1.0";
                        var szOnoverStyle = map.szMapPanBorderOnoverStyle + ";stroke-width:" + map.Scale.normalX(1) + ";opacity:1.0";
                        var panButton = null;
     ...
     * @param nDeltyY the y panning amount in pixel
     */
    ixMap.Viewport.prototype.panMap = function (nDeltaX, nDeltaY) {
     ...
     */
    ixMap.Viewport.prototype.setBackgroundColor = function (szColor) {
        if (this.eventRect) {
     ...
     */
    ixMap.Viewport.prototype.togglePanBorder = function () {
        var SVGDoc = map.SVGDocument;
     ...
     */
    ixMap.Viewport.prototype.createNorthArrow = function () {
        ...
        if (widgetGroup) {
            ...
            if (map.szNorthArrowPosition == "TOP") {
                this.northGroup.fu.setPosition(this.widgetBox.x + this.widgetBox.width - map.Scale.normalX(75), map.Scale.normalX(45 + map.nToolMarginTop));
            } else {
                this.northGroup.fu.setPosition(this.widgetBox.x + this.widgetBox.width - map.Scale.normalX(75), this.widgetBox.y + map.Scale.normalX((this.widgetBox.y ? 50 : 60) + map.nToolMarginTop));
            }
            ...
            zoomOut.setPosition(map.Scale.normalY(0), map.Scale.normalY(40 + map.nNormalButtonSize * 2));
    ...
    ixMap.Viewport.prototype.showNorthArrow = function () {
        if (this.northGroup) {
            this.northGroup.style.setProperty("display", "inline", "");
        }
    };
    ixMap.Viewport.prototype.hideNorthArrow = function () {
     ...
     * clip the map
     */
    ixMap.Viewport.prototype.clipMap = function (newWidth) {
        var clipRect = map.SVGDocument.getElementById("mapcliprect");
        if (clipRect) {
    ...
    ixMap.Zoom = function (nZoom) {
        ...
        this.zoomNode = map.SVGDocument.getElementById("mapzoomandpan");
     ...
     * resets zoom
     */
    ixMap.Zoom.prototype.toFullExtend = function () {
     ...
     */
    ixMap.Zoom.prototype.setNewZoom = function (newZoom) {
        this.doZoom = newZoom;
        //	displayMessage("please wait ...");
     ...
     */
    ixMap.Zoom.prototype.setNewPan = function (nDeltaX, nDeltaY) {
     ...
     */
    ixMap.Zoom.prototype.setNewArea = function (newArea) {
        this.fAreaSet = true;
     ...
     */
    ixMap.Zoom.prototype.setNewCenter = function (newArea) {
     ...
     */
    ixMap.Zoom.prototype.execute = function () {
     ...
     * cancel executing
     */
    ixMap.Zoom.prototype.cancel = function () {
     ...
     * reset map zooming
     */
    ixMap.Zoom.prototype.reset = function () {
        this.zoomNode.setAttributeNS(null, "transform", "matrix(1 0 0 1 0 0)");
        map.SVGRootElement.currentTranslate.x = 0;
        map.SVGRootElement.currentTranslate.y = 0;
        this.nZoom = 1;
        map.Event.doDefaultZoom(null);
        clearMessage(100);
    };
     ...
     */
    ixMap.Zoom.prototype.getBox = function () {
        ...
        xOff -= (map.Scale.normalX(map.SVGRootElement.currentTranslate.x) + zoomMatrixA[4]) / this.nZoomX;
        yOff -= (map.Scale.normalY(map.SVGRootElement.currentTranslate.y) + zoomMatrixA[5]) / this.nZoomY;
     ...
     */
    ixMap.Zoom.prototype.getEnvelope = function () {
     ...
     */
    ixMap.Zoom.prototype.getEnvelopeString = function () {
     ...
     * </ul>
     */
    ixMap.Zoom.prototype.getFractionBox = function () {
        ...
        zoomMatrixA[4] = pRotated.x;
        zoomMatrixA[5] = pRotated.y;
        var xOff = (map.Scale.normalX(map.SVGRootElement.currentTranslate.x) + zoomMatrixA[4]) / this.nZoomX;
        var yOff = (map.Scale.normalY(map.SVGRootElement.currentTranslate.y) + zoomMatrixA[5]) / this.nZoomY;
     ...
     * </ul>
     */
    ixMap.Zoom.prototype.setFractionBox = function (nBox) {
     ...
     */
    ixMap.Zoom.prototype.clipArea = function (rectArea) {
     ...
     */
    ixMap.Zoom.prototype.isVisibleBox = function (bBox) {
     ...
     * @return true or false
     */
    ixMap.Zoom.prototype.isCompletelyVisibleBox = function (bBox) {
     ...
     */
    ixMap.Zoom.prototype.doExecuteZoomMap = function (nZoom, nOldZoom) {
        ...
        var zoomMatrixA = getMatrix(this.zoomNode);
        var newX = (map.SVGRootElement.currentTranslate.x + map.Scale.embedX(zoomMatrixA[4])) / nOldZoom * nZoom;
        var newY = (map.SVGRootElement.currentTranslate.y + map.Scale.embedX(zoomMatrixA[5])) / nOldZoom * nZoom;
     ...
     */
    ixMap.Zoom.prototype.doZoomMapToArea = function (rectArea) {
        ...
        if (map.fZoomByViewer && map.fPanByViewer) {
            this.zoomNode.setAttributeNS(null, "transform", "matrix(1 0 0 1 0 0)");
            map.SVGRootElement.currentScale = nNewZoom;
        } else if (map.fPanByViewer) {
     ...
     */
    ixMap.Zoom.prototype.doCenterMapToArea = function (rectArea) {
        ...
        if (map.fZoomByViewer && map.fPanByViewer) {
            map.SVGRootElement.currentScale = this.nZoom;
            map.SVGRootElement.currentTranslate.x = map.Scale.embedX(newX - rectArea.width / 2) * this.nZoomX;
            map.SVGRootElement.currentTranslate.y = map.Scale.embedY(newY - rectArea.height / 2) * this.nZoomY;
        } else if (map.fPanByViewer) {
            map.SVGRootElement.currentTranslate.x = map.Scale.embedX(newX);
            map.SVGRootElement.currentTranslate.y = map.Scale.embedY(newY);
        } else {
    ...
    ixMap.Zoom.prototype.doPanFixed = function (deltaX, deltaY) {
        var fixedNodes = map.SVGFixedGroup.childNodes;
        ...
        var toolsNodes = map.SVGToolsGroup.childNodes;
     ...
     */
    ixMap.Zoom.prototype.doZoomMapToWidgetRect = function (rectArea) {
        ...
        var matrixA = map.antiZoomAndPanList.getActualMatrix();
     ...
     * @param lonNE the longitude of the North East point
     */
    ixMap.Zoom.prototype.doZoomMapToGeoBounds = function (latSW, lonSW, latNE, lonNE) {
        var ptSW = map.Scale.getMapCoordinateOfLatLon(latSW, lonSW);
        var ptNE = map.Scale.getMapCoordinateOfLatLon(latNE, lonNE);
        if (ptSW && ptNE) {
     ...
     */
    ixMap.Zoom.prototype.doZoomMapToView = function (center, nZoom) {
        try {
            map.HTMLWindow.ixmaps.htmlgui_setCenterAndZoom({
                lat: center[0],
                lng: center[1]
            }, nZoom);
        } catch (e) {
    ...
    ixMap.Zoom.prototype.doZoomMapToLayer = function (szLayerName) {
        ...
        var layerNode = map.SVGDocument.getElementById(szLayerName);
        ...
        if (szLayerName == "maplayer") {
            ...
            for (var a in map.Layer.listA) {
                if (!a.match(/legend/)) {
                    var layerBoxNode = map.SVGDocument.getElementById(a + "::bbox");
                    if (layerBoxNode) {
    ...
    ixMap.Zoom.prototype.doZoomMapToItem = function (szId) {
        ...
        var ItemNode = map.SVGDocument.getElementById(szId);
     ...
     * @param lonNE the longitude of the North East point
     */
    ixMap.Zoom.prototype.doSetMapToGeoBounds = function (latSW, lonSW, latNE, lonNE) {
        this.fExternalZoom = false;
        var ptSW = map.Scale.getMapCoordinateOfLatLon(latSW, lonSW);
        var ptNE = map.Scale.getMapCoordinateOfLatLon(latNE, lonNE);
        if (ptSW && ptNE) {
     ...
     */
    ixMap.Zoom.prototype.getCenterOfMapInGeoPosition = function () {
        var rectArea = this.getBox();
     ...
     */
    ixMap.Zoom.prototype.getBoundsOfMapInGeoBounds = function () {
        var rectArea = this.getBox();
     ...
     */
    ixMap.Zoom.prototype.doCheckEnvelope = function (minBoundX, maxBoundX, minBoundY, maxBoundY) {

        if (!map.fLimitMapToExtent) {
            return true;
        }
     ...
     */
    ixMap.Zoom.prototype.doSetAreaByParentMap = function (rectArea) {
     ...
     */
    ixMap.Zoom.prototype.doSetEnvelopeByParentMap = function (minBoundX, maxBoundX, minBoundY, maxBoundY) {
        ...
        try {
            ...
            return map.HTMLWindow.ixmaps.htmlgui_setCurrentEnvelopeByGeoBounds(ptSW, ptNE);
        } catch (e) {
            return false;
        }
    };
     ...
     * @return true, if new area has been set 
     */
    ixMap.Zoom.prototype.doCenterByParentMap = function (rectArea) {
     ...
     */
    ixMap.Zoom.prototype.doZoomMap = function (nFactor, szMode) {
    ...
    ixMap.Zoom.prototype.doPanMap = function (nDeltaX, nDeltaY) {
        ...
        try {
            ...
            try {
                map.HTMLWindow.ixmaps.htmlgui_setCurrentEnvelope(this.getEnvelopeString(), false);
            } catch (e) {}
        }
    };
    /**
     ...
     */
    ixMap.Zoom.prototype.checkZoomLimit = function (nNewZoom) {
        var nLimit = 1000000;
        if (map.fPDFEmbed) {
            nLimit = 20;
     ...
     */
    ixMap.Zoom.prototype.removeClipping = function (evt) {
        if (map.fClipMapDynamic) {
            var mapClipNode = map.SVGDocument.getElementById("mapclip");
     ...
     * @param evt the mouse event
     */
    ixMap.Zoom.prototype.activateClipping = function (evt) {
        if (map.fClipMapDynamic) {
            var mapClipNode = map.SVGDocument.getElementById("mapclip");
     ...
     * @param evt the mouse event
     */
    ixMap.Zoom.prototype.onMouseMove = function (evt) {};
    /**
     * execute mousedown event, inherited from the overviewmap (does nothing)
     * @param evt the mouse event
     */
    ixMap.Zoom.prototype.onMouseDown = function (evt) {};
    /**
     ...
     * @param evt the mouse event
     */
    ixMap.Zoom.prototype.onMouseUp = function (evt) {
    ...
    /**
     * Create a new ixMap.Layer instance.  
     * @class It realizes an object for layer handling
     * @constructor
     * @throws 
     * @return A new ixMap.Layer Object
     */
    ixMap.Layer = function (evt) {
        ...
        this.layerNode = map.SVGDocument.getElementById("maplayer");
        /** array to hold the {@link ixMap.Layer.Item} objects, that each describe one single layer @type array */
        this.listA = new Array(0);
        /** array (named!) to hold the {@link ixMap.Layer.Dependency} objects, that describe the layer dependencies (minscale,maxscale,...) @type named array */
        ...
        this.objectGroup = map.SVGDocument.getElementById(map.szObjectGroupId);
        ...
        if (layerNodesA.length) {
            ...
            for (i = 0; i < layerNodesA.length; i++) {
                this.listA[layerNodesA.item(i).getAttributeNS(null, "name")] = new ixMap.Layer.Item(layerNodesA.item(i));
            }
        }
        var scaleDepNodes = map.SVGDocument.getElementsByTagNameNS(szMapNs, "scaledependency");
    ...
    ixMap.Layer.prototype = new Map();

    /**
     * Create a new ixMap.Layer.Item instance.  
     * @class It realizes an object for layer handling
     * @constructor
     * @throws 
     * @return A new ixMap.Layer.Item Object
     */
    ixMap.Layer.Item = function (layerNode) {
        if (layerNode) {
    ...
    /**
     * Create a new ixMap.Layer.Dependency instance.  
     * @class It realizes an object for layer scale depemdecies
     * @constructor
     * @throws 
     * @return A new ixMap.Layer.Dependency Object
     */
    ixMap.Layer.Dependency = function (scaleDepNode) {
        if (scaleDepNode) {
            ...
            for (var i = 0; i < layerA.length; i++) {
                if (layerA.item(i).nodeType == 1) {
                    ...
                    if (szTheme && (szTheme != szLayer)) {
                        ...
                        if (!map.SVGDocument.getElementById("legend:" + szState + ":" + szTheme)) {
                            continue;
                        }
     ...
     */
    ixMap.Layer.prototype.switchLayer = function (evt, szLayer, szClassName, nState) {
        ...
        if (szLayer && !szLayer.match(/label/) && szLayer.match(/::/) && (nState === true)) {
            ...
            // do it here 
            var targetNode = map.SVGDocument.getElementById("legend:off:" + szLayer.split("::")[0]);
            if (targetNode && (targetNode.style.getPropertyValue("display") != "inline")) {
                targetNode = map.SVGDocument.getElementById("legend:suboff:" + szLayer.split("::")[0]);
                if (targetNode) {
     ...
     */
    ixMap.Layer.prototype.switchLayerOnTiles = function (szLayer, nState) {
        var nRetval = false;
     ...
     * @return true, if the switching could been executed
     */
    ixMap.Layer.prototype.switchLayerByFeature = function (szLayer, nState) {
        var x;
        var nRetval = false;
    ...
    ixMap.Layer.prototype.switchLayerByCSS = function (evt, szLayer, szClassName, szProperty) {
        ...
        if (map.Scale.CSSStyleNodes) {
            ...
            map.CSS = new ixMap.CSS(map.Scale.CSSStyleNodes);
     ...
     * @param evt the event
     * @param targetGroup root node to search for layer (if null, map.SVGRootElement is used)
     */
    ixMap.Layer.prototype.switchScaleDependentLayer = function (evt, targetGroup) {

        if (!map.fDynamicLayer) {
            return;
        }
        ...
        // -------------------------------------------------------------------
        var szStylesValue = "";
        if (map.Scale.CSSStyleNodes && map.Scale.CSSStyleNodes.firstChild.nextSibling && map.fSwitchByCSS) {
            var styleNodes = map.Scale.CSSStyleNodes;
            ...
            for (a in this.depListA) {
                ...
                if (depObj.szDisplayAttribute != depObj.szOldDisplayAttribute) {
                    ...
                    if (depClass.length > 3) {
                        ...
                        var shapeObj = map.SVGDocument.getElementById(depObj.shapeId);
                        if (shapeObj) {
        ...
        // ------------------------------------------
            ...
            targetGroup = targetGroup ? targetGroup : map.SVGRootElement;
     ...
     * @return true or false
     */
    ixMap.Layer.prototype.isScaleDependentLayer = function (szLayerId) {
     ...
     * @return true or false
     */
    ixMap.Layer.prototype.isScaleDependentLayerOn = function (szLayerId) {
        if (this.depListA && this.depListA[szLayerId]) {
     ...
     * @type void
     */
    ixMap.Layer.prototype.zoomToScaleDependentLayerOn = function (szLayerId) {
     ...
     * @return true or false
     */
    ixMap.Layer.prototype.isLayerOn = function (szLayerId) {
     ...
     */
    ixMap.Layer.prototype.changeLayerOpacity = function (szLayer, nDelta) {
        var nRetval = false;
     ...
     * @return true, if the opacity changing could been executed
     */
    ixMap.Layer.prototype.changeOpacityOnTiles = function (szLayer, nDelta) {
        var nRetval = false;
        if (map.Tiles && map.Tiles.nCount > 0) {
            var szTilesIdA = map.Tiles.getTileNodeIds(szLayer);
            for (var i = 0; i < szTilesIdA.length; i++) {
     ...
     * @return true, if the switching could been executed
     */
    ixMap.Layer.prototype.changeOpacity = function (szLayer, nDelta) {
        var x;
        var nRetval = false;
        var featureNode = this.document.getElementById(szLayer);
        if (featureNode) {
     ...
     */
    ixMap.Layer.prototype.changeNodeOpacity = function (nodeObj, nDelta, szOpacityProperty) {
     ...
     * @param evt the event
     * @param rootGroup root node to search for pattern (if null, map.SVGRootElement is used)
     */
    ixMap.Layer.prototype.initPatternScaling = function (evt, rootGroup) {
    ...
    ixMap.Layer.prototype.changeLineScaling = function (evt, nDelta) {
        this.doFeatureScaling(nDelta);
        map.Scale.nLineScaling *= nDelta;
    };
    ixMap.Layer.prototype.changeLabelScaling = function (evt, nDelta) {
     ...
     */
    ixMap.Layer.prototype.changeFeatureScaling = function (evt, newScale, fOverride) {
        ...
        var zoomMatrixA = getMatrix(map.Scale.zoomNode);
        var nZoom = zoomMatrixA[0];
        var newX = zoomMatrixA[4] + map.Scale.scaleX(map.SVGRootElement.currentTranslate.x);
        var newY = zoomMatrixA[5] + map.Scale.scaleY(map.SVGRootElement.currentTranslate.y);
        ...
        // filter --------------------------------------------
        nodeA = map.SVGRootElement.getElementsByTagName('filter');
        ...
        this.scaleLineDecorations(map.SVGRootElement, newScale);
     ...
     */
    ixMap.Layer.prototype.doFeatureScaling = function (nDelta) {
            ...
            if (map.fFeatureScalingByLayer) {
                ...
                for (var a in map.Layer.listA) {
                    ...
                    // handle normal layer
                        ...
                        if (layerItem.szName) {
                            var layerNode = map.SVGDocument.getElementById(layerItem.szName);
                            if (layerNode) {
                ...
                var layerNode = map.SVGDocument.getElementById("mapobjects");
                nodeTempA = layerNode.getElementsByTagName('g');
                for (var j = 0; j < nodeTempA.length; j++) {
                    nodeStyleA[nodeStyleA.length] = nodeTempA.item(j);
                    nodeStyleDeltaA[nodeStyleA.length - 1] = 1;
     ...
     * @param nDelta the scaling factor
     */
    ixMap.Layer.prototype.doObjectScaling = function (newScale) {

        if (!map.fObjectScaling) {
            return;
        }
        ...
        if (fDoit) {
            ...
            for (var i = 0; i < nodeA.length; i++) {
                ...
                if (map.antiZoomAndPanList.isContained(nodeA.item(i))) {
     ...
     * @param evt the event
     */
    ixMap.Layer.prototype.doStoredFeatureScaling = function (evt) {
     ...
     */
    ixMap.Layer.prototype.scaleTextOffsets = function (targetGroup, newScale, nDelta, cssStyles) {
     ...
     * @param newScale the new zoom scale
     */
    ixMap.Layer.prototype.scaleLineDecorations = function (targetGroup, newScale) {
     ...
     * @param nDelta the scaling factor
     */
    ixMap.Layer.prototype.doLabelScaling = function (nDelta) {
        ...
        if (cssStyles) {
            ...
            for (n = 0; n < nodeA.length; n++) {
                if (map.antiZoomAndPanList.isContained(nodeA.item(n))) {
                    continue;
                }
                var szId = nodeA.item(n).getAttributeNS(null, "id");
     ...
     */
    ixMap.Layer.prototype.changeObjectScaling = function (evt, nDelta, objGroup) {
     ...
     * @param objGroup the DOM node of the object layer
     */
    ixMap.Layer.prototype.setObjectRotate = function (evt, nRot, objGroup) {
     ...
     */
    ixMap.Layer.prototype.setPatternRotate = function (evt, nRot, rootGroup) {
        var nodeA = null;
        var i = 0;
        var n = 0;
     ...
     * @param objGroup the DOM node of the object layer
     */
    ixMap.Layer.prototype.setSymbolRotate = function (evt, nRot, objGroup) {
     ...
     * @param objGroup the DOM node of the object layer
     */
    ixMap.Layer.prototype.changeObjectRotate = function (evt, nDelta, objGroup) {
     ...
     * @param nDelta the scaling factor
     */
    ixMap.Layer.prototype.setLabelRotate = function (evt, nRot) {
     ...
     * @param nDelta the scaling factor
     */
    ixMap.Layer.prototype.changeLabelRotate = function (evt, nDelta) {
     ...
     */
    ixMap.Layer.prototype.adaptLabel = function (evt, rootNode) {
        // initiate dynamic label, if wanted
        if (map.fAdaptLabelToScaling) {
            this.adaptLabelToScaling(evt, rootNode);
        }
        if (map.fCheckLabelOverlap || map.fCheckLabelSpace || map.fCheckLabelSqueeze) {
            if (rootNode) {
     ...
     * @param rootNode the DOM node from which on to look for labels on path
     */
    ixMap.Layer.prototype.adaptLabelToScaling = function (evt, rootNode) {

        if (!rootNode) {
            rootNode = map.SVGRootElement;
        }
        if ((map.fAdaptLabelToScaling || map.fCheckLabelOnlyOne)) {
            var fDoit = false;
            for (var a in map.Layer.listA) {
                var layerItem = map.Layer.listA[a];
            ...
            if (!map.Label.fAdaptLabelToScalingPending) {
                ...
                if (map.fAdaptLabelToScaling == 'delayed') {
                    map.pushAction(() => {
                        setTimeout(() => {map.Label.adaptLabelToScaling(null);},1500);
                    });
                } else {
                    map.pushAction(() => {
                        map.Label.adaptLabelToScaling(null,null);
                    });
                }
            }
        }
     ...
     */
    ixMap.Layer.prototype.checkLabelOverlapping = function (evt, rootNode) {
     ...
     * @param rootNode the DOM node to start looking for labels
     */
    ixMap.Layer.prototype.prepareCheckOverlap = function (evt, rootNode) {

        if ((map.fCheckLabelOverlap || map.fCheckLabelSpace)) {
            if (!rootNode) {
                rootNode = map.Layer.layerNode;
            }
            if (!rootNode) {
     ...
     */
    ixMap.Layer.prototype.addChangedFeatureNode = function (featureNode) {
        var i;
     ...
     */
    ixMap.Layer.prototype.isChangedFeature = function (szId) {
        var i, k;
        if (this.changedFeatureNodesA) {
            for (i = 0; i < this.changedFeatureNodesA.length; i++) {
     ...
     * @param szId the id of the theme (layer)
     */
    ixMap.Layer.prototype.removeChangedFeatures = function (szId) {
        var i, k;
        if (this.changedFeatureNodesA) {
            for (i = 0; i < this.changedFeatureNodesA.length; i++) {
                if (map.Tiles.getMasterId(this.changedFeatureNodesA[i].getAttributeNS(null, "id")) == szId) {
     ...
     * @return true if done
     */
    ixMap.Layer.prototype.setPointerEvents = function (szId) {
        for (var a in map.Layer.listA) {
     ...
     * @type {@link ixMap.Layer.Item}
     * @return a layer object, if defined
     */
    ixMap.Layer.prototype.getLayerObj = function (szId) {
        if (!szId) {
            return null;
        }
     ...
     */
    ixMap.Layer.prototype.getLayerName = function (szId) {
     ...
     */
    ixMap.Layer.prototype.getLayerObjOfNode = function (nodeObj) {
        if (nodeObj) {
     ...
     */
    ixMap.Layer.prototype.getLayerItemNodeOfNode = function (nodeObj) {
        while (nodeObj.parentNode && nodeObj.parentNode.nodeName != 'SVG') {
            var layerObj = this.getLayerObj(nodeObj.getAttributeNS(null, "id"));
            if (layerObj) {
                return nodeObj;
     ...
     */
    ixMap.Layer.prototype.getLayerItemNodes = function (nodeObj) {
        var layerItemNode = this.getLayerItemNodeOfNode(nodeObj);
        if (layerItemNode) {
            var szId = layerItemNode.getAttributeNS(null, "id");
            var layerObj = this.getLayerObj(szId);
            if (((layerObj.szType == "point") && map.fTileTextNoClip) || (map.Tiles.getMasterId(szId) == szId)) {
     ...
     */
    ixMap.Layer.prototype.getStyleOrClass = function (nodeObj) {
        var retObj = {};
     ...
     * @return true or false
     */
    ixMap.Layer.prototype.isMapObject = function (nodeObj) {
        while (nodeObj) {
     ...
     * @return true or false
     */
    ixMap.Layer.prototype.isLoaded = function (szLayer) {
    ...
    ixMap.Label.prototype = new Map();
    /**
     * Create a new ixMap.Label.Item instance.  
     * @class It realizes an object for one label handling
     * @constructor
     * @throws 
     * @return A new ixMap.Label.Item Object
     */
    ixMap.Label.Item = function (textNode) {
        if (textNode) {
            this.textNode = textNode;
            this.szId = textNode.getAttributeNS(null, "id") || "noId";
            this.bgNode = map.SVGDocument.getElementById(this.szId + ":bg");
            this.bbNode = map.SVGDocument.getElementById(this.szId + ":textbg");
            this.poNode = map.SVGDocument.getElementById(this.szId.slice(0, this.szId.length - 1));
            if (!this.poNode) {
                var szId = map.Tiles.getMasterId(this.szId);
                szId = szId.slice(0, szId.length - 1);
                this.poNode = map.SVGDocument.getElementById(szId);
            }
            this.bBox = null;
        } else {
     ...
     */
    ixMap.Label.Item.prototype.setDisplay = function (szMode) {
     ...
     */
    ixMap.Label.Item.prototype.setScale = function (xScale, yScale) {
     ...
     */
    ixMap.Label.Item.prototype.scaleBackground = function () {
    ...
    ixMap.Label.prototype.prepareCheckOverlap = function (rootNode) {
        ...
        for (var j = 0; j < nodeTempA.length; j++) {
            if (nodeTempA.item(j).firstChild &&
                ...
                var cItem = new ixMap.Label.Item(nodeTempA.item(j));
     ...
     * @param rootNode the DOM SVG node to beginn to search for label
     */
    ixMap.Label.prototype.initCheckOverlap = function (rootNode) {
        ...
        if (map.fPDFEmbed || !map.Tiles.dataNode) {
     ...
     * @type {@link ixMap.Label.Item}
     * @return the item, if found
     */
    ixMap.Label.prototype.getCheckItem = function (nIndex) {
     ...
     */
    ixMap.Label.prototype.getCheckItemCount = function () {
     ...
     */
    ixMap.Label.prototype.addCheckItem = function (textNode, fScale) {

        if (!textNode) {
            var cItem = new ixMap.Label.Item(null);
        ...
        if (!map.fCheckLabelOverlap && (layerObj.szType != "polygon")) {
            return;
        }
        ...
        for (var aI = aA.length - 1; aI >= 0; aI--) {
            ...
            if (layerItem.szFlag.match(/tiled/)) { // && (layerItem.nRenderer & (4|8)) ){
                    ...
                    if (tileInfoA) {
                        ...
                        for (var i = 0; i < tileInfoA.length; i++) {
                            if (tileInfoA[i].tileGroup.style.getPropertyValue("display") == "inline") {
                                ...
                                if (map.fCheckOverlapClipOnTiles) {
                                    this.addCheckItem(null);
                                }
                            }
                        }
                ...
                if (layerItem.szName) { //&& ((layerItem.szDisplayLabel != "none")) ){
                    ...
                    var layerNode = map.SVGDocument.getElementById(layerItem.szName + ":values");
                    if (layerNode) {
                        nodeTempA = layerNode.getElementsByTagName('text');
                        if (nodeTempA.length) {
    ...
    ixMap.Label.prototype.getBoxCheckOverlap = function (startIndex) {
        ...
        for (var i = startIndex; i >= 0; i++) {
            ...
            if (cItem) {
                if ((cItem.szId == "mapLabelNullItem") && map.fCheckOverlapImplicit) {
                    this.nodeA.length = 0;
                    continue;
                }
                try {
     ...
     * @param cItem the {@link ixMap.Label.Item} to check
     * @type boolean
     * @return true or false
     */
    ixMap.Label.prototype.checkLabelSpace = function (cItem, bBox) {
        var szRefId = null;
        ...
        // ----------------------------------------
        var refNode = map.SVGDocument.getElementById(szRefId);
        if (refNode) {
            // check if label fits on polygon space
            // ------------------------------------
            cItem.refBox = map.Dom.getBox(refNode);
            var refBox = cItem.refBox;
            refBox.width *= map.nCheckLabelSpace;

            if ((bBox.width > refBox.width) && map.fAdaptLabelToScaling) {
                var nSqueeze = 1;
                var nSize = 1;
                // if we can squeeze the width to fit (max.60%), we do here
                if (map.fCheckLabelSqueeze && ((bBox.width <= refBox.width * 2) || !map.fCheckLabelSpace)) {
                    nSqueeze = Math.max(0.7, refBox.width / bBox.width);
                    bBox.width *= nSqueeze;
                    cItem.setScale(nSqueeze, 1);
                }
                // if we can size the text to fit (max.25%), we do here
                if (map.fCheckLabelSize && ((bBox.width <= refBox.width * 1.5) || !map.fCheckLabelSpace)) {
                ...
                if (!map.fCheckLabelSpace || (bBox.width <= refBox.width)) {
                    cItem.setDisplay("inline");
                }
     ...
     */
    ixMap.Label.prototype.doCheckOverlap = function () {
        ...
        if (map.fCheckLabelOverlap == "delayed") {
     ...
     * @param startIndex an actual startindex into the label item list; necessary for the sleeping 
     */
    ixMap.Label.prototype.execCheckLabelOverlappingOnly = function (startIndex) {
     ...
     */
    ixMap.Label.prototype.execCheckLabelOverlappingOne = function (nIndex) {
        ...
        if (map.Zoom.isVisibleBox(cItem.bBox)) {
            ...
            if (map.fCheckLabelOverlap) {
                ...
                for (var j = 0; j < nIndex; j++) {
                    ...
                    if (map.fCheckLabelOnlyOne && (szTextA == szTextB)) {
     ...
     * @param rootNode the DOM node from which on to look for labels on path
     */
    ixMap.Label.prototype.adaptLabelToScaling = function (evt, rootNode) {
     ...
     */
    ixMap.Label.prototype.execAdaptLabelToScaling = function (startIndex) {
        ...
        for (var i = startIndex; i < nodeA.length; i++) {
            ...
            if (refNode) {
                ...
                if (map.Layer.isScaleDependentLayerOn(szId) === false) {
                    ...
                    var nodeBg = map.SVGDocument.getElementById(nodeTe.getAttributeNS(null, "id") + ":bg");
                    if (nodeBg) {
     ...
     */
    ixMap.Label.prototype.getLabel = function (szId) {

        if (!map.SVGDocument.getElementById(szId)) {
        ...
        var nodeX = map.SVGDocument.getElementById(szId);
        if (!nodeX) {
            return null;
        }
        if (nodeX.tagName == "g") {
        ...
        if (szX) {
            if (szX.match(/#/)) {
                var szXA = szX.split("#");
                var nodeT = map.SVGDocument.getElementById(szXA[0] + "T#" + szXA[1]);
            } else {
                var nodeT = map.SVGDocument.getElementById(szX + "T");
            }
            if (nodeT) {
    ...
    /**
     * Create a new ixMap.Sleep instance.  
     ...
     * <br>	
     * <br>	&nbsp;&nbsp;var mapSleep = new <strong>ixMap.Sleep</strong>("myFunction",25,"");
     * <br>	
     ...
     * @return A new ixMap.Sleep Object
     */
    ixMap.Sleep = function (szFunction, nMaxCount, szMessage) {
     ...
     * @param szMessage messag to display with progressbar
     */
    ixMap.Sleep.prototype.initCheckSleep = function (nMaxCount, szMessage) {
     ...
     */
    ixMap.Sleep.prototype.checkSleep = function (szContinueParam, nTimeout) {
     ...
     * @return true, if the process has been interrupted	
     */
    ixMap.Sleep.prototype.checkSleepMS = function (szContinueParam, nTimeout) {
    ...
    /**
     * Create a new ixMap.Tiles instance.  
     ...
     * @constructor
     * @throws 
     * @return A new ixMap.Tiles Object
     */
    ixMap.Tiles = function () {
        ...
        if (tilesNodesA.length) {
            ...
            this.tilesNode = map.SVGDocument.getElementsByTagNameNS(szMapNs, "maptiles");
     ...
     */
    ixMap.Tiles.prototype.getTileNodes = function (szBasicId) {
        var tileNodesA = new Array(0);
        var tileNodeIdsA = this.getTileNodeIds(szBasicId);
        for (var i = 0; i < tileNodeIdsA.length; i++) {
            var tileNode = map.SVGDocument.getElementById(tileNodeIdsA[i]);
            if (tileNode) {
     ...
     */
    ixMap.Tiles.prototype.getTileNodeIds = function (szBasicId) {
     ...
     */
    ixMap.Tiles.prototype.getTilePositions = function () {
     ...
     */
    ixMap.Tiles.prototype.getTileBox = function (szId) {
     ...
     */
    ixMap.Tiles.prototype.getTileInfo = function () {
        var xStart = map.Scale.origMinX; // -map.Scale.mapOffset.x;
        var yStart = map.Scale.origMinY; // -map.Scale.mapOffset.y;
        ...
        for (var y = Math.floor(this.nCount / 2); y <= this.nCount && y >= 0;) {
            ...
            for (var x = Math.floor(this.nCount / 2); x <= this.nCount && x >= 0;) {
                ...
                if (x < this.nCount && y < this.nCount) {
                    ...
                    var tileNode = map.SVGDocument.getElementById(szId);
                    var sBox = new box(xStart + x * this.tileWidth, yStart + y * this.tileHeight, this.tileWidth, this.tileHeight);
                    ...
                    tileNode = map.SVGDocument.getElementById(szId);
                    if (tileNode) {
                        tileInfoA[tileInfoA.length] = {
                            szUrl: szUrl,
                            szGroup: szId,
     ...
     */
    ixMap.Tiles.prototype.getMasterId = function (szId) {
        if (szId == null) {
            return null;
        }
     ...
     */
    ixMap.Tiles.prototype.getTileId = function (szId) {
        if (szId == null) {
            return null;
        }
        var szIdA = szId.split(':');
     ...
     */
    ixMap.Tiles.prototype.buildTileExtension = function (x, y) {
     ...
     */
    ixMap.Tiles.prototype.setShapeStyle = function (leadingNode, szStyle) {
        if (leadingNode && this.nCount) {
            ...
            for (var i = 0; i < szTilesIdA.length; i++) {
                var shapeNode = map.SVGDocument.getElementById(szTilesIdA[i] + szShapeId);
                if (shapeNode) {
     ...
     */
    ixMap.Tiles.prototype.markTiles = function () {
        var objectGroup = map.SVGDocument.getElementById("maptilesbg");
        if (objectGroup) {
            for (var y = 0; y < this.nCount; y++) {
                for (var x = 0; x < this.nCount; x++) {
     ...
     * @param evt the event
     */
    ixMap.Tiles.prototype.switchScaleDependentTiles = function (evt) {

        if (!map.fDynamicTiles) {
            return;
        }
    ...
    ixMap.Tiles.prototype.loadScaleDependentTiles = function (szId, szUrl) {
        ...
        if (this.xLoader.importSVGFile(szUrl, map.SVGDocument, tileGroup, null)) {
            map.fTilesLoaded = true;
        }
    };
    /**
     ...
     */
    ixMap.Tiles.prototype.isLoading = function () {
        if (this.xLoader) {
     ...
     */
    ixMap.Tiles.prototype.clearTiles = function (evt) {
        if (!map.fDynamicTiles) {
            return false;
        }
     ...
     * @param evt the event
     */
    ixMap.Tiles.prototype.discardTiles = function (evt) {
        if (map.fTilesLoaded && map.fDiscardTiles && !this.fDiscardPending) {
     ...
     * @param evt the event
     */
    ixMap.Tiles.prototype.doDiscardTiles = function (evt) {
        if (!(map.fDynamicTiles && map.fTilesLoaded)) {
            this.fDiscardPending = false;
            return;
        }
        if (map.mouseObject) {
     ...
     * @return true or false
     */
    ixMap.Tiles.prototype.isAnyTiledLayerVisible = function () {
        for (var a in map.Layer.listA) {
            var layerItem = map.Layer.listA[a];
            if (layerItem.szFlag.match(/tiled/)) {
     ...
     * @return true or false
     */
    ixMap.Tiles.prototype.allTilesLoaded = function () {
     ...
     * @return true or false
     */
    ixMap.Tiles.prototype.isAnyLayerTileLoaded = function (szLayer) {
    ...
    /**
     * Create a new ixMap.Event instance.  
     * @class It provides all event handler 
     * @constructor
     * @throws -
     * @return A new Event object
     */
    ixMap.Event = function () {
     ...
     */
    ixMap.Event.prototype.initUseNodes = function (rootNode) {
        if (!rootNode) {
            return;
        }
     ...
     * @param evt the event handle
     */
    ixMap.Event.prototype.resolveInstance = function (objNode) {
        if (!objNode) {
            return null;
        }
     ...
     * @param evt the event handle
     */
    ixMap.Event.prototype.stopMouseEvent = function (evt) {
        if (evt) {
            evt.stopPropagation();
            evt.preventDefault();
        }
     ...
     * @param evt the event handle
     */
    ixMap.Event.prototype.defaultMouseOver = function (evt) {
        if (!evt || !evt.target) {
            return;
        }
        ...
        if (map.SVGPopupGroup.fu.isContained(onoverShape) || map.SVGFixedGroup.fu.isContained(onoverShape)) {
        ...
        if ((map.szMapToolType === "") && !this.onoverPopup) {
            return;
        }

        // HTML interface interception

        if (map.szMapToolType == "clickinfo") {
            try {
        ...
        if ((!this.onoverPopup) &&
            ...
            try {
                if (map.HTMLWindow.ixmaps.htmlgui_onItemOver(evt, mapObject.szId, onoverShape)) {
                    map.SVGPopupGroup.fu.clear();
                    map.highLightList.unlock();
                    map.highLightList.removeAll();
                    map.highLightList.addItem(mapObject.objNode, "scale");
                    map.highLightList.lock();
                    map.HTMLWindow.ixmaps.htmlgui_onSVGPointerIdle();
                    return null;
                }
            } catch (e) {}
    ...
    var __normalHighlight = function (evt, onoverShape) {
        ...
        if (szId.length === 0 || szId.match(/legend/) ||
            ...
            szId.match(/widget/) ||
            szId.match(/textgrid/) ||
            (map.szMapToolType != "clickinfo" && map.szMapToolType != "info" && map.szMapToolType !== "")) {
            if (map.highLightList) {
                map.highLightList.removeAll();
            }
            return false;
        }
        if (map.highLightList && !map.highLightList.checkItem(onoverShape)) {
            ...
            for (var i = 0; i < shapeNodesA.length; i++) {
                if (map.highLightList.addItem(shapeNodesA[i], szMode)) {
    ...
    var __circleHighlight = function (evt, mapObject) {
        ...
        if (map.highLightList && !map.highLightList.checkItem(mapObject.objNode)) {
            map.highLightList.unlock();
            map.highLightList.removeAll();
            //map.highLightList.addItem(mapObject.objNode, __isChart(null, mapObject.objNode) ? "isolate" : "");
            map.highLightList.addItem(mapObject.objNode, "circle");
            map.highLightList.lock();
        }
    };
    /**
     ...
     * @param evt the event handle
     */
    ixMap.Event.prototype.defaultMouseOut = function (evt) {
        if (!evt || !evt.target) {
            return;
        }
        ...
        if (this.onoverShape && !map._activeItem) {
            map.highLightList.removeItem(this.onoverShape);
            this.onoverShape = null;
     ...
     * @param evt the event handle
     */
    ixMap.Event.prototype.defaultMouseClick = function (evt) {
        var opacity = 1.0;
        if (!evt || !evt.target) {
            return;
        }
        ...
        if (aNode.nodeName == "a") {
            ...
            try {
                map.HTMLWindow.ixmaps.htmlgui_popupWindow(szRef);
     ...
     * @param evt the event handle
     */
    ixMap.Event.prototype.defaultMouseDown = function (evt) {
        ...
        if (szId.match(/movabley/)) {
            map.mouseObject = new MouseObject(evt, clickNode, "yonly");
            return;
        }
        if (szId.match(/movablex/)) {
            map.mouseObject = new MouseObject(evt, clickNode, "xonly");
            return;
        }
        if (szId.match(/movable/)) {
            map.mouseObject = new MouseObject(evt, clickNode);
            return;
        }
        ...
        if (szId.match(/legend/)) {
            ...
            if (!evt.shiftKey && !evt.altKey && !evt.crtlKey && map.Layer.isMapObject(clickNode)) {
                if (map.szMapToolType && map.szMapToolType !== "") {
                    var mapTool = new MapTool(evt, map.szMapToolType);
                }
            }
            if (evt.shiftKey && !evt.altKey && !evt.crtlKey && map.Layer.isMapObject(clickNode)) {
                if (map.szMapToolType === "") {
                    mapTool = new MapTool(evt, "pan");
                } else {
                    mapTool = new MapTool(evt, map.szMapToolType);
                }
            }
            // GR 25.01.2012 allow pan within info, starts on mouse down and move
            if (map.fTriggerMouseMoveForPan &&
                !(szId.match(/legend/) ||
                    szId.match(/tool/) ||
                    szId.match(/button/) ||
                    szId.match(/widget/) ||
                ...
                if (map.szMapToolType == "info" || map.szMapToolType === "") {
     ...
     * @param evt the event handle
     */
    ixMap.Event.prototype.defaultMouseUp = function (evt) {
        if (!evt || !evt.target || map.fInitializing) {
            return;
        }
        this.stopMouseEvent(evt);
     ...
     * @param evt the event handle
     */
    ixMap.Event.prototype.defaultMouseMove = function (evt) {
        if (!evt || !evt.target || map.fInitializing) {
            return;
        }
        var objNode = this.resolveInstance(evt.target);
        ...
        if (map.mouseObject) {
            try {
                map.mouseObject.onMouseMove(evt);
            } catch (e) {}
        }
        if (this.fPanDone) {
            this.fPanDone = false;
    ...
    ixMap.Event.prototype.defaultKeyDown = function (evt) {
        if (!evt || __fShiftDone) {
            return;
        }
        // switch map tool on shift key
        if (evt.shiftKey && !evt.altKey && !evt.crtlKey) {
            __szOldMapToolType = map.szMapToolType;
            if (map.szMapToolType == "pan") {
                setMapTool("zoomrect");
            } else
            if (map.szMapToolType == "zoomrect") {
                setMapTool("pan");
            } else
            if (map.szMapToolType == "info") {
                setMapTool("pan");
            }
            __fShiftDone = true;
        }
     ...
     * @param evt the event handle
     */
    ixMap.Event.prototype.defaultKeyUp = function (evt) {
        if (!evt || !__fShiftDone) {
            return;
        }
     ...
     * @param evt the event
     */
    ixMap.Event.prototype.doDefaultZoom = function (evt) {
        ...
        if (map.Scale.nZoomScale != newZoomScale) {
            ...
            try {
                map.HTMLWindow.ixmaps.htmlgui_onItemClick(evt, "mapbackground:eventrect");
            } catch (e) {}
        }
        ...
        if (map.fPanByViewer === false) {
            if (map.SVGRootElement.currentTranslate.x !== 0 ||
                map.SVGRootElement.currentTranslate.y !== 0) {
                ...
                // GR 15.11.2007 respect canvas rotation  
                var pRotated = map.Scale.rotatePoint(map.SVGRootElement.currentTranslate);
                map.SVGRootElement.currentTranslate.x = pRotated.x;
                map.SVGRootElement.currentTranslate.y = pRotated.y;
            ...
            var clipRect = map.SVGDocument.getElementById("mapcliprect");
            if (clipRect) {
                clipRect.setAttributeNS(null, "x", map.Scale.scaleX(-map.SVGRootElement.currentTranslate.x));
                clipRect.setAttributeNS(null, "y", map.Scale.scaleY(-map.SVGRootElement.currentTranslate.y));
            ...
            var eventRect = map.SVGDocument.getElementById("mapbackground:eventrect");
            if (eventRect) {
                eventRect.setAttributeNS(null, "x", map.Scale.scaleX(-map.SVGRootElement.currentTranslate.x));
                eventRect.setAttributeNS(null, "y", map.Scale.scaleY(-map.SVGRootElement.currentTranslate.y));
        ...
        if (evt) {
            map.antiZoomAndPanList.adjustGroups(evt);
        }
        ...
        if (Math.abs(map.Scale.oldZoomScale - map.Scale.nZoomScale) > (map.Scale.oldZoomScale / 100)) {
            ...
            if ((map.Scale.oldZoomScale > map.Scale.nZoomScale) && (map.fDynamicLayer == "delayed")) {
        ...
        if (this.fFrozenDynamicContent ||
            ...
            try {
                ...
                map.HTMLWindow.ixmaps.htmlgui_onZoomAndPan(map.Scale.nZoomScale);
            } catch (e) {}

            if ((map.fDynamicTiles == "delayed") || (map.fDynamicLayer == "delayed")) {
            ...
            try {
                ...
                map.HTMLWindow.ixmaps.htmlgui_setScaleSelect(String(__formatValue(Math.floor(map.Scale.nTrueMapScale * map.Scale.nZoomScale)), 0, "BLANK"));
            } catch (e) {}
        }

        map.zoomAndPanHistory.newItem();
    ...
    ixMap.Event.prototype.doPrintZoom = function (evt) {
        ...
        try {
            ...
            map.HTMLWindow.ixmaps.htmlgui_setCurrentEnvelope(map.Zoom.getEnvelopeString(), (map.Scale.oldZoomScale != map.Scale.nZoomScale));
        } catch (e) {}
     ...
     * @param evt the event
     */
    ixMap.Event.prototype.doDefaultResize = function (evt) {
        if (map && map.Layer) {
            map.Layer.switchScaleDependentLayer(evt);
            displayScale(evt);
        }
     ...
     * @param evt the event
     */
    ixMap.Event.prototype.doDefaultPan = function (evt) {
        if (evt && !map.mouseObject) {
            map.antiZoomAndPanList.adjustGroups(evt);
     ...
     * @param evt the event
     */
    ixMap.Event.prototype.doDefaultAdjustPan = function (evt) {
        if (this.fPanDone) {
            this.fPanDone = false;
            this.doDefaultZoom(null);
        }
     ...
     * @param evt the event
     */
    ixMap.Event.prototype.moveToFrontOfGroup = function (evt) {
     ...
     */
    var InfoContainer = function (targetDocument, targetGroup, szInfoId, ptPosition, ptOffset, szMode, szTitle) {
    ...
    InfoContainer.prototype.create = function () {
        ...
        this.frameNode.setAttributeNS(null, "rx", map.Scale.normalX(map.nInfoRoundRect * 2));
        this.frameNode.setAttributeNS(null, "ry", map.Scale.normalX(map.nInfoRoundRect * 2));
        // create shadow  
        if (map.SVGDocument.getElementById(map.szShadowFilterToolsId)) {
            this.frameNode.style.setProperty("filter", "url(#" + map.szShadowFilterToolsId + ")", "");
        }
        ...
        if (this.szMode.match(/pin/)) {
            var pinButton = map.SVGDocument.getElementById("pin_button");
            if (pinButton) {
    ...
    Slider.prototype.onMouseDown = function (evt) {
        if (this.moveArea.width === 0) {
            map.mouseObject = new MouseObject(evt, this.objNode, "yonly");
        } else if (this.moveArea.height === 0) {
            map.mouseObject = new MouseObject(evt, this.objNode, "xonly");
        } else {
            map.mouseObject = new MouseObject(evt, this.objNode, null);
        }
        map.mouseObject.parent = this;
    ...
    RotationSlider.prototype.onMouseDown = function (evt) {
        ...
        map.mouseObject = new MouseObject(evt, this.circlethumbNode);
        map.mouseObject.parent = this;
        this.isActive = true;
        if (this.parent) {
            try {
    ...
    MapToolList.prototype.onMouseDown = function (evt) {
        ...
        if (mapObject) {
            ...
            if (mapTool) {
                map.mouseObject = new MouseObject(evt, mapObject.objNode, "parentonly", mapTool);
                map.mouseObject.parent = mapTool;
            }
        }
        return;
    };
    ...
    var MapTool = function (evt, szType, nPos) {
        ...
        this.objNode = map.Dom.newGroup(map.SVGToolsGroup, szType + String(Math.random()));
        ...
        switch (szType) {
            case "coord":
                map.mouseObject = new MouseObject(evt, null, "parentonly");
                map.mouseObject.parent = this;
                ...
                endPoint.fu.setPosition(map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y);
                this.redraw();
            ...
            case "polygon":
                ...
                var polylinePath = map.SVGDocument.getElementById(szPolylineId);
                if (polylinePath == null) {
                    polylinePath = map.Dom.newNode('path', map.SVGToolsGroup);
            ...
            case "measurebuffer":
            case "selectbuffer":
                map.mouseObject = new MouseObject(evt, null);
                map.mouseObject.parent = this;

                map.Dom.newShape('circle', this.objNode, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, map.Scale.normalX(1), this.szLineBgStyle);
                map.Dom.newShape('circle', this.objNode, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, map.Scale.normalX(1), (this.szType == "measurebuffer" || this.szType == "selectbuffer") ? this.szBufferStyle : this.szLineStyle);
                map.Dom.newShape('line', this.objNode, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, this.szLineBgStyle);
                map.Dom.newShape('line', this.objNode, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, this.szLineStyle);

                textObj = map.Dom.newGroup(this.objNode, "distance-text" + String(Math.random()));
                map.Dom.newShape('rect', textObj, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y - map.Scale.normalY(5) - map.Scale.normalY(this.nFontSize * 7 / 7), 1000, map.Scale.normalY(this.nFontSize * 1.3), this.szFillBgStyle);
                map.Dom.newText(textObj, map.mouseObject.mouseStartPosition.x + map.Scale.normalX(5), map.mouseObject.mouseStartPosition.y - map.Scale.normalY(5), this.szTextStyle, "test");

                endPoint = map.Dom.newGroup(this.objNode, "endpoint" + String(Math.random()));
                map.Dom.newShape('circle', endPoint, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, map.Scale.normalX(5.5), this.szFillBgStyle);
                map.Dom.newShape('line', endPoint, map.mouseObject.mouseStartPosition.x - map.Scale.normalX(10), map.mouseObject.mouseStartPosition.y, map.mouseObject.mouseStartPosition.x + map.Scale.normalX(10), map.mouseObject.mouseStartPosition.y, this.szLineStyleLite);
                map.Dom.newShape('line', endPoint, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y - map.Scale.normalX(10), map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y + map.Scale.normalX(10), this.szLineStyleLite);
                map.Dom.newShape('circle', endPoint, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, map.Scale.normalX(3.7), this.szLineStyle);

                startPoint = map.Dom.newGroup(this.objNode, "startpoint" + String(Math.random()));
                map.Dom.newShape('circle', startPoint, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, map.Scale.normalX(5.5), this.szFillBgStyle);
                map.Dom.newShape('line', startPoint, map.mouseObject.mouseStartPosition.x - map.Scale.normalX(10), map.mouseObject.mouseStartPosition.y, map.mouseObject.mouseStartPosition.x + map.Scale.normalX(10), map.mouseObject.mouseStartPosition.y, this.szLineStyleLite);
                map.Dom.newShape('line', startPoint, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y - map.Scale.normalX(10), map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y + map.Scale.normalX(10), this.szLineStyleLite);
                map.Dom.newShape('circle', startPoint, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, map.Scale.normalX(3.7), this.szLineStyle);
                break;
            case "zoomrect":
            case "selectrect":
                map.mouseObject = new MouseObject(evt, null);
                map.mouseObject.parent = this;
                map.Dom.newShape('rect', this.objNode, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, 10, 10, this.szLineBgStyle);
                map.Dom.newShape('rect', this.objNode, map.mouseObject.mouseStartPosition.x, map.mouseObject.mouseStartPosition.y, 10, 10, this.szLineStyle);
                break;
            case "pan":
                map.mouseObject = new MouseObject(evt, null);
                map.mouseObject.parent = this;
    ...
    MapTool.prototype.onMouseDown = function (evt) {
        var mapObject = new MapObject(evt.target);
        if (mapObject) {
            map.mouseObject = new MouseObject(evt, mapObject.objNode);
            map.mouseObject.parent = this;
        }
        return;
    };
    ...
    MapTool.prototype.onMouseMove = function (evt) {
        ...
        var i;
        var newMousePosition = map.Scale.getClientMousePosition(evt, map.SVGToolsGroup);
        var deltaX = newMousePosition.x - map.mouseObject.mouseStartPosition.x;
        var deltaY = newMousePosition.y - map.mouseObject.mouseStartPosition.y;
        ...
        switch (this.szType) {
            ...
            case "selectbuffer":
                ...
                var nDistance = map.Scale.getDistanceInMeter(map.mouseObject.mouseStartPosition.x,
                    map.mouseObject.mouseStartPosition.y,
                    newMousePosition.x,
                    newMousePosition.y);
            ...
            case "pan":
                if (map.fPDFEmbed || !map.fPanToolByViewer) {
                    ...
                    map.mouseObject.mouseStartPosition.x = newMousePosition.x;
                    map.mouseObject.mouseStartPosition.y = newMousePosition.y;
                } else {
                    ...
                    deltaX = newMousePosition.x - map.mouseObject.mouseStartPosition.x;
                    deltaY = newMousePosition.y - map.mouseObject.mouseStartPosition.y;
    ...
    MapTool.prototype.onMouseUp = function (evt) {
        ...
        switch (this.szType) {
            ...
            case "pan":
                displayMessage("please wait ...", 500);
                setTimeout("map.Event.doDefaultZoom(null)", map.fPanToolByViewer ? 5 : 200);
                this.endPan(evt);
                break;
            case "measurement":
            case "measurebuffer":
    ...
    MapTool.prototype.endPan = function (evt) {
        map.fFroozeDynamicContent = false;
    };
    /**
     * end panning: hide the toolsGroup, ...
     * @param evt the actual event
    ...
    MapTool.prototype.hideLayer = function (evt) {
        for (var a in map.Layer.listA) {
            ...
            if (layerItem.szFlag.match(/invisiblepan/)) {
                ...
                featureNode = map.SVGDocument.getElementById(a);
                if (featureNode) {
                    layerItem.szBeforeHideStyle = featureNode.style.getPropertyValue('display');
                    featureNode.style.setProperty('display', 'none', "");
                }
                featureNode = map.SVGDocument.getElementById(a + ":label");
                if (featureNode) {
                    layerItem.szBeforeHideLabelStyle = featureNode.style.getPropertyValue('display');
                    featureNode.style.setProperty('display', 'none', "");
                }
                featureNode = map.SVGDocument.getElementById(a + ":label:bg");
                if (featureNode) {
                    layerItem.szBeforeHideLabelStyle = featureNode.style.getPropertyValue('display');
                    featureNode.style.setProperty('display', 'none', "");
                }
    ...
    MapTool.prototype.redraw = function (evt) {
        ...
        switch (this.szType) {
            ...
            case "polygon":
                ...
                var polygonPath = map.SVGDocument.getElementById(szPolygonId);
                if (polygonPath == null) {
                    break;
                }
                ...
                // ---------------------------------------------------------
                var phantomPointGroup = map.SVGDocument.getElementById("maptools_phantomPointGroup");
                ...
                if (!textGroup) {
                    textGroup = map.Dom.newGroup(map.SVGToolsGroup, "maptools_polygon_text");
                } else {
            ...
            case "polyline":
                ...
                textGroup = map.SVGDocument.getElementById(szPolylineTextId);
                if (!textGroup) {
    ...
    var setMapTool = function (szType) {
        ...
        map.Dom.clearGroup(map.SVGMenuGroup);
        map.Dom.clearGroup(map.SVGToolsGroup);
        mapToolList.clear();
        map.szMapToolType = szType;
        if (map.fPDFEmbed && map.fSetToolCursor) {
            setTimeout("setMapToolCursor('" + szType + "')", 100);
        }
        try {
            map.HTMLWindow.ixmaps.htmlgui_setMapTool(szType);
        } catch (e) {}
    ...
    var setMapToolCursor = function (szType) {
        ...
        cursorGroup = map.SVGDocument.getElementById('mapbackground');
        if (cursorGroup) {
            cursorGroup.setAttributeNS(null, 'cursor', 'url(#' + szType + '_cursor)');
        }
        cursorGroup = map.SVGDocument.getElementById('mapcanvas');
        if (cursorGroup) {
            cursorGroup.setAttributeNS(null, 'cursor', 'url(#' + szType + '_cursor)');
        }
        if (map.SVGToolsGroup) {
            map.SVGToolsGroup.setAttributeNS(null, 'cursor', 'url(#' + szType + '_cursor)');
        }
    };
    /**
     * set map cursor according active tool
    ...
    var setMapToolActive = function (szType) {
        ...
        var activeNode = null;
        activeNode = map.SVGDocument.getElementById('legend:activatetool:' + szType);
        if (activeNode) {
    ...
    */
     ...
     */
    var TextField = function (evt, targetGroup, szTemplate, nFontSize) {
        var textTemplate = map.SVGDocument.getElementById(szTemplate);
        if (textTemplate) {
            ...
            this.textGroup.fu.scale(map.Scale.normalX(1), map.Scale.normalY(1));
            if (map.fMapBorder3D && map.SVGDocument.getElementById(map.szShadowFilterId)) {
                this.sdNode = map.Dom.newShape('rect', this.textGroup, 0, 0, 1, 1, "fill:#444444;opacity:0.2;stroke:none");
                this.sdNode.setAttributeNS(null, "rx", map.nInfoRoundRect * nFontSize / 6);
                this.sdNode.setAttributeNS(null, "ry", map.nInfoRoundRect * nFontSize / 6);
            }
            this.bgNode = map.Dom.newShape('rect', this.textGroup, 0, 0, 1, 1, "fill:#ffffff;stroke:#888888;stroke-width:2;");
            this.bgNode.setAttributeNS(null, "rx", map.nInfoRoundRect * nFontSize / 6);
            this.bgNode.setAttributeNS(null, "ry", map.nInfoRoundRect * nFontSize / 6);
            ...
            this.sdNode.setAttributeNS(null, "rx", map.nInfoRoundRect);
            this.sdNode.setAttributeNS(null, "ry", map.nInfoRoundRect);
            this.bgNode.setAttributeNS(null, "rx", map.nInfoRoundRect);
            this.bgNode.setAttributeNS(null, "ry", map.nInfoRoundRect);
            this.textNode = map.Dom.newText(this.textGroup, 0, 0, "font-family:arial;font-size:" + nFontSize + "px;fill:black", "");
            this.workspaceNode = this.textNode.parentNode;
            if (szTemplate == "transparent") {
                this.textGroup.setAttributeNS(null, "opacity", "0.4");
                this.sdNode.setAttributeNS(null, "rx", map.nInfoRoundRect * 5);
                this.sdNode.setAttributeNS(null, "ry", map.nInfoRoundRect * 5);
                this.bgNode.setAttributeNS(null, "rx", map.nInfoRoundRect * 5);
                this.bgNode.setAttributeNS(null, "ry", map.nInfoRoundRect * 5);
            }
        }
    };
    /**
    ...
    */
    ...
    var ScrollArea = function (evt, targetGroup, szTemplate, nMaxWidth, nMaxHeight, nScrollBarWidth) {
        ...
        var areaTemplate = map.SVGDocument.getElementById(szTemplate);
        if (areaTemplate) {
            ...
            this.workspaceNode = map.SVGDocument.getElementById(szTemplate + ":workspace" + szInstance);
            /** the clipping rectangle @type DOM node */
            this.cliprectNode = map.SVGDocument.getElementById(szTemplate + ":cliprect" + szInstance);
        } else {
    ...
    HighLight.prototype.startToggle = function () {
        if (map.nHighlightToggle > 0) {
            this.toggleCount = map.nHighlightToggle * 2;
    ...
    ixMap.prototype.displayInfo = function (evt, infoShape, szMode) {
    ...
    var doDisplayInfo = function (xPos, yPos, szMode) {
        ...
        if (map.SVGDocument.getElementById(szAvoidDoubletteId)) {
            return null;
        }
        ...
        if (szId && szId.length) {
            ...
            imageNode = map.SVGDocument.getElementById(szIdImage + ":" + "image");
        }
        ...
        var offset = new point(map.Scale.normalX(map.nInfoOffsetX), map.Scale.normalY(map.nInfoOffsetY));
        var szInfoId = "info:" + String(Math.random());

        var newInfo = new InfoContainer(map.SVGDocument, map.SVGPopupGroup, szInfoId + (szMode.match(/pointer/) ? "" : ":movable"), position, offset, szMode);
        ...
        try {
            ...
            szInfoTitle = map.HTMLWindow.ixmaps.htmlgui_onInfoTitle(szInfoTitle, textA);
        } catch (e) {}
        ...
        if (text && text.length && titles.length && !dataGrid) {
            ...
            // ===================
            if (textA.length) {
                var newText = createTextGrid(map.SVGDocument, infoWorkspace, szInfoId + ":textgrid", textA, 2, 14);
        ...
        try {
            var userGroup;
            if ((userGroup = map.HTMLWindow.ixmaps.htmlgui_onInfoDisplayExtend(map.SVGDocument, szObjId))) {
        ...
        if (szMode.match(/fix/)) {
            ...
            newInfo.objectNode.fu.scale(map.nFixedInfoScale, map.nFixedInfoScale);

            map.SVGFixedGroup.appendChild(newInfo.objectNode);
     ...
     */
    var _doRemoveFixedInfo = function (thisInfo) {
    ...
    ixMap.prototype.removeInfo = function () {
        map.SVGFixedGroup.fu.clear();
    };
    ...
    function doDisplayInfoDelayed() {
        if (map.SVGPopupGroup.hasChildNodes) {
    ...
    var createTextGrid = function (targetDocument, targetGroup, groupName, textArray, nColumns, fontHeight, styleArray, bgStyle) {
        ...
        var fBgPattern = map.SVGDocument.getElementById("TextLinesBgPattern");
        var szStyle = bgStyle ? bgStyle : "fill:#ffffff;stroke:" + (map.szTextGridStyle.match(/background/) ? "1" : "none");
        ...
        for (c = 0; c < nColumns; c++) {
            ...
            for (i = 0; i < lines; i++) {
                if (nColumns > 1 && c === 0 && !fBgPattern && map.szTextGridStyle.match(/background/) && (!map.szTextGridStyle.match(/alternate/) || i % 2)) {
                ...
                var newLine = map.Dom.newText(newxGroup, 0, dy, "font-family:arial;font-size:" + map.Scale.normalY(fontheight) + "px;fill:" + map.szInfoBodyColor + "", textArray[i + c * lines]);
            ...
            if (map.szTextGridStyle.match(/firstright/) && c === 0) {
                for (i = 0; i < lines; i++) {
        ...
        for (i = 0; i < lines; i++) {
            if (newBgA[i]) {
                if (map.szTextGridStyle.match(/full/)) {
        ...
        var patternNode = map.SVGDocument.getElementById("TextLinesBgPattern:antizoomandpan");
        if (patternNode) {
    ...
    function createTextField(SVGDocument, SVGTargetGroup, szId, szText, fontheight) {
        ...
        if (SVGDocument && SVGTargetGroup) {
            ...
            var newText = map.Dom.newText(newGroup, 0, map.Scale.normalY(fontheight * 1.25), "font-family:arial;font-size:" + map.Scale.normalY(fontheight) + "px;fill:" + map.szInfoBodyColor + "", szText);
    ...
    function displayScale(evt, szPosition) {
        ...
        if (!scaleGroup) {
            scaleGroup = map.Dom.newGroup(map.SVGMenuGroup, 'legend:scalegroup');
        }
        ...
        if (1) {
            ...
            var textNode = map.Dom.newText(scaleGroup, 0, map.Scale.normalY(fontheight), "font-family:arial;font-size:" + map.Scale.normalY(fontheight / 4 * 3) + "px;fill:" + map.szInfoBodyColor + "", szScale);
        ...
        if (nBarMaxWidth > 0) {
            ...
            for (var i = 0; i < 20; i++) {
                ...
                map.Dom.newText(scaleGroup, (i === 0) ? map.Scale.normalX(nXpos) : map.Scale.normalX(nXpos - 4), map.Scale.normalY(nYpos + 5 + fontheight / 3 * 2), "font-family:arial;font-size:" + map.Scale.normalY(fontheight / 3 * 2) + "px;fill:" + map.szInfoBodyColor + ";pointer-events:none;", szText);
        ...
        if (szPosition) {
            ...
            var nMapBorder = map.Scale.normalX(map.nMapBorderWidth);
    ...
    /**
     * Create a new ixMap.Toolbar instance.  
     ...
     * @throws 
     * @param evt the actual event
     * @return A new ixMap.Toolbar Object
     */
    ixMap.Toolbar = function (evt) {
        this.init(evt);
    };
    ixMap.Toolbar.prototype = new Map();
     ...
     * @param evt the event
     */
    ixMap.Toolbar.prototype.init = function (evt) {
        var toolbarNode = map.SVGDocument.getElementById("legend:toolbar");
        var toolbarSrc = map.SVGDocument.getElementById("toolbar");
     ...
     * @param evt the event
     */
    ixMap.Toolbar.prototype.refresh = function (evt) {
        var toolbarNode = map.SVGDocument.getElementById("legend:toolbar");
        if (toolbarNode && (!map.Legend || !map.Legend.objNode || !map.Legend.objNode.fu.isContained(toolbarNode))) {
            var nBorder = map.Scale.normalX(map.nMapBorderWidth);
    ...
    /**
     * Create a new ixMap.Legend instance.   
    ...
    ixMap.Legend = function (evt) {
        ...
        if (map.fAllIncluded || map.fPDFEmbed) {
            this.init();
        } else {
            setTimeout("map.Legend.init()", 500);
        }
    };
    ixMap.Legend.prototype = new Map();
     ...
     */
    ixMap.Legend.prototype.init = function (evt) {
        ...
        var legendParamNode = map.SVGDocument.getElementById("legend:param");
        if (legendParamNode) {
        ...
        var markerRect = map.SVGDocument.getElementById('test:markerrect');
        if (markerRect) {
        ...
        var showButton = map.SVGDocument.getElementById('legend:show:button');
        if (showButton) {
        ...
        if (legendBody && legendBodyBg) {
                ...
                if (map.fLegendToggleButtons) {
                    ...
                    if (!map.SVGDocument.getElementById('legend:hide:button')) {
                        ...
                        if (style == 1) {
                            ...
                            if (map.fMapBorder3D && map.SVGDocument.getElementById(map.szShadowFilterId)) {
                                xButtonObj.nodeObj.setAttributeNS(null, "style", "filter:url(#" + map.szShadowFilterId + ");opacity:0.5");
                            }
                        }
                    }
                    if (!map.SVGDocument.getElementById('legend:show:button')) {
                        ...
                        if (map.fMapBorder3D && map.SVGDocument.getElementById(map.szShadowFilterId)) {
                            xButtonObj.nodeObj.style.setProperty("filter", "url(#" + map.szShadowFilterId + ")", "");
                        }
            ...
            // 3. legend is within map 
                ...
                this.objNode.fu.setPosition(map.Scale.normalX(8 + map.nMapBorderWidth), map.Scale.normalY(map.nMapBorderWidth));
            ...
            if (this.fInMap) {
                if (map.fObjectPseudoShadow && !this.shadowNode) {
                    var a;
        ...
        if (legendBody && legendBodySwitch && map.fInitLegendOff) {
    ...
    ixMap.Legend.prototype.move = function (evt) {
        map.mouseObject = new MouseObject(evt, this.objNode);
    };
     ...
     * @param evt the event
     */
    ixMap.Legend.prototype.hide = function (evt) {
     ...
     * @param evt the event
     */
    ixMap.Legend.prototype.show = function (evt) {
        this.objNode.style.setProperty("display", "inline", "");
     ...
     */
    ixMap.Legend.prototype.getPosition = function (evt) {
        var SVGDoc = evt ? evt.target.ownerDocument : map.SVGDocument;
        var legendGroup = SVGDoc.getElementById("legend:group");
        if (legendGroup) {
                ...
                for (var i = 0; i < childNodes.length; i++) {
                    if (childNodes.item(i).nodeType == 1) {
                        ...
                        if (szId.match(/overviewmap/)) {
                            var embededClipPath = map.SVGDocument.getElementById("overviewmap:clippath");
                            if (embededClipPath) {
     ...
     */
    ixMap.Legend.prototype.checkGroupCollapse = function (evt, leadNode) {
        var SVGDoc = evt ? evt.target.ownerDocument : map.SVGDocument;
        if (leadNode == null) {
     ...
     */
    ixMap.Legend.prototype.legendMouseClick = function (evt, clickNode) {
     ...
     */
    ixMap.Legend.prototype.execLegendMouseClick = function (evt, clickNode, szThemeId, szAction, szOnlyClassName) {
        ...
        if ((szAction == 'backwards') && (!szThemeId.match(/label/))) {
            map.zoomAndPanHistory.backwards();
            return true;
        }
        ...
        switch (szAction) {
            ...
            case 'on':
                ...
                var targetNode = map.SVGDocument.getElementById(szId);
                if (targetNode) {
                    targetNode.style.setProperty('display', 'inline', "");
                }
                if (!szThemeId.match(/label/) && map.fCheckSublayerCollapse) {
     ...
     */
    ixMap.Legend.prototype.execLegendMouseClickOnTiles = function (evt, clickNode, szThemeId, szAction) {
        var nRet = false;
     ...
     */
    ixMap.Legend.prototype.switchLegendCheckBox = function (evt, szThemeId, szDisplayAttribute) {
        var szId = "legend:off:" + szThemeId;
        var targetNode = map.SVGDocument.getElementById(szId);
        if (!targetNode) {
            targetNode = map.SVGDocument.getElementById(szId + ":byclassname");
        }
        if (targetNode) {
            targetNode.style.setProperty("display", szDisplayAttribute, "");
        }
        szId = "legend:setactive:" + szThemeId;
        targetNode = map.SVGDocument.getElementById(szId);
        if (targetNode) {
    ...
    function __setThemeState(szThemeId, szAction) {
        var themeNodesA = map.SVGDocument.getElementsByTagNameNS(szMapNs, "theme");
        if (themeNodesA) {
                    ...
                    switch (szAction) {
                        case 'collapse':
                            ...
                            if (1) {
                                ...
                                map.SVGHiddenGroup.appendChild(legendNodesA.item(i + 1));
                            }
                            break;
                        case 'expand':
                            if ((legendNodesA.item(i).getAttributeNS(szMapNs, "state") != 'collapsed') &&
                            ...
                            if (legendNodesA.item(i).getAttributeNS(null, "id").match(/placeholder/)) {
                                ...
                                origNode = map.SVGDocument.getElementById(szOrigId);
    ...
    map.zoomAndPanHistory = new History();

    // initialize highlighting                                    
    map.highLightList = new HighLight();

    // ========================================
    // BACKWARD COMPATIBILITY EXPORTS         *
    // ========================================

    window.InfoContainer = InfoContainer;
    window.MapTool = MapTool;
    window.TextField = TextField;
    window.ScrollArea = ScrollArea;
    window.HighLight = HighLight;

    window.doDisplayInfo = doDisplayInfo;
    window._removeInfo = _removeInfo;
    window._doRemoveFixedInfo = _doRemoveFixedInfo;
    window.setMapTool = setMapTool;
    window.createTextGrid = createTextGrid;

})(); // End of IIFE - All functions are now local!
